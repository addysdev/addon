...
public class BatchController {
    ...
    * @throws BizException
    */
   @RequestMapping({"/batch/closeserviceendsms"})
   public ModelAndView closeServiceSendSms(HttpServletRequest request, 
   		                              HttpServletResponse response) throws IOException, BizException
   {
     ...
     try{
		...
		smsVO.setSmsMsg("[애디스] A/S서비스에 등록된 예상 종료일이 이틀 남은건이 있습니다.A/S미처리건을 확인하셔서 처리 부탁드립니다.");
