...
<!-- 사용자관리 -->
  ...
  <!-- //조회결과리스트 -->
  <!-- //사용자 등록/삭제 -->
  <button type="button" class="btn btn-primary" onClick="fcUserManage_excelForm()">품목 excel 업로드</button>
  <button type="button" class="btn btn-primary" onClick="fcUserManage_excelForm()">안전재고 excel 업로드</button>
  <button type="button" class="btn btn-primary" onClick="fcUserManage_excelForm()">보유재고 excel 업로드</button>
  <!-- 사용자 일괄등록-->
